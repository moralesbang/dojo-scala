...
object WebServer {
  ...
  //Modelos, entidades de nuestro back
  ...
  //Como vamos a realizar una conexion via HTTP, necesitamos parsear nuestros valores a JSON
  implicit val notesFormat = jsonFormat1(Note)
